...
$$
$$
\log\left[p\left(\mu \mid \mathbf{x}, \sigma\right)\right] \propto \sum_{n=1}^{N}\{(x_{n}-\mu)^2\}- (\mu-\mu_{0})^{2} 
$$
### 2b)
...
\frac{-1}{2\sigma^{2}}\sum_{n=1}^{N}\dfrac{d}{d\mu}\{(x_{n}-\mu)^2\}- \frac{1}{2\tau_{0}^{2}}\dfrac{dy}{dx}(\mu-\mu_{0})^{2} = \\
...
$$
\frac{-1}{2\sigma^{2}}\sum_{n=1}^{N}\dfrac{d}{d\mu}\{(x_{n}-\mu)^2\}= \frac{-1}{2\sigma^{2}} \times
$$
...
\log\left(\frac{1}{\sqrt{2\pi\sigma^2}}\right) - {\frac{1}{2\sigma^2} \sum_{n=1}^{N} (x_{n}-\mu)^{2}} + \log(\lambda)-\lambda\sigma
$$
$$
log[p \left(\sigma \mid \mathbf{x}, \mu\right)] \propto \log\left(\frac{1}{\sqrt{2\pi\sigma^2}}\right) - {\frac{1}{2\sigma^2} \sum_{n=1}^{N} (x_{n}-\mu)^{2}} -\lambda\sigma
$$
...
Add as many equation blocks as you see fit to answer this question.  
$$
\log\left(\frac{1}{\sqrt{2\pi\sigma^2}}\right) - {\frac{1}{2\sigma^2} \sum_{n=1}^{N} (x_{n}-\mu)^{2}} -\lambda\sigma=\\
\log\left(\frac{1}{\sqrt{2\pi\sigma^2}}\right) - \frac{v}{2\sigma^2}  -\lambda\sigma
$$
### 3c)
...
The log-posterior has one mode, and the shape of it is a parabola.
...
```{r, solution_03f, eval=FALSE}
### set the input arguments !!!
log_post_varphi_unnorm <- function( )
{
